...
def is_valid_password(password):
    ...
    if count_upper == 0 or count_digit == 0 or count_lower == 0 or len(password) < MIN_LENGTH or len(password) > MAX_LENGTH:
        return False
...
main()
#or len(password) < MIN_LENGTH or len(password) > MAX_LENGTH