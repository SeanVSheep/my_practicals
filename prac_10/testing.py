...
def repeat_string(s, n):
    ...
    NON STUPID WAY TO SOLVE THIS >return " ".join([s] * n)<"""
    new_string = ''
...
def run_tests():
    ...
    assert not isinstance(test_car.odometer, str), "Car has set odometer to a string"
    assert not test_car.odometer > 10, "Car has set starting odometer greater than 10"


def get_formatted(phrase):
    """
    >>> get_formatted('hello')
    'Hello.'
    >>> get_formatted('It is an ex parrot.')
    'It is an ex parrot.'
    >>> get_formatted('thats cool')
    'Thats cool.'
    """
